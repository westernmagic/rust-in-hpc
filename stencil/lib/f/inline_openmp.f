...
!> @date 2020-07-19
!> @licence LGPL-3.0
subroutine diffuse_inline_openmp(in_field, out_field, nx, ny, nz, num_halo, alpha, num_iter) bind(C)
    ...
    do iter = 1, num_iter
        ...
        !$omp parallel &
        !$omp   default(none) &
        !$omp   shared(iter, nx, ny, nz, num_halo, num_iter, alpha_20, alpha_08, alpha_02, alpha_01) &
